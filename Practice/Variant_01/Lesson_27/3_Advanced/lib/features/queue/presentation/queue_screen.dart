...
class _QueueScreenContent extends StatelessWidget {
  ...
  Future<void> _onRefresh(BuildContext context) async {
    ...
    context.read<QueueCubit>().loadClients();

    late StreamSubscription subscription;
    subscription = context.read<QueueCubit>().stream.listen((state) {
            ...
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  ...
                  tooltip: 'Riverpod версія',
                  onPressed: () {
                    context.router.push(const QueueRiverpodRoute());
                  },
                ),
                IconButton(
