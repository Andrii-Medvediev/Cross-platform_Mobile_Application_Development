...
/// generated route for
/// [QueueRiverpodScreen]
class QueueRiverpodRoute extends PageRouteInfo<void> {
  const QueueRiverpodRoute({List<PageRouteInfo>? children})
    : super(QueueRiverpodRoute.name, initialChildren: children);

  static const String name = 'QueueRiverpodRoute';

  static PageInfo page = PageInfo(
    name,
    builder: (data) {
      return const QueueRiverpodScreen();
    },
  );
}
