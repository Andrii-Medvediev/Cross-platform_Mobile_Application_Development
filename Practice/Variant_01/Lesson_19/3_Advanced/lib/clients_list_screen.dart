...
class _ClientsListScreenState extends State<ClientsListScreen> {
  ...
  void _removeClient(int index, BuildContext context) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('${removedClient['name']} видалено з черги'),
        ...
        action: SnackBarAction(
          ...
          onPressed: () {
            setState(() {
              _clients.insert(index, removedClient);
            });
          },
        ),
      ),
  ...
  Widget _buildListView() {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        return Dismissible(
          key: Key(_clients[index]['name'] + index.toString()),
          ...
          onDismissed: (direction) => _removeClient(index, context),
          child: ListTile(
